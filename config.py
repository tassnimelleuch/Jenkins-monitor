...
class Config:
    ...
    GITHUB_SYNC_INTERVAL_SECONDS = int(os.getenv('GITHUB_SYNC_INTERVAL_SECONDS', '60'))
    GITHUB_ANALYTICS_CACHE_TIMEOUT_SECONDS = int(
        os.getenv('GITHUB_ANALYTICS_CACHE_TIMEOUT_SECONDS', '300')
    )
    GITHUB_SUMMARY_CACHE_TIMEOUT_SECONDS = int(
        os.getenv('GITHUB_SUMMARY_CACHE_TIMEOUT_SECONDS', '20')
    )
    GITHUB_INITIAL_BACKFILL_HOURS = int(os.getenv('GITHUB_INITIAL_BACKFILL_HOURS', '48'))
    GITHUB_RETENTION_DAYS = int(os.getenv('GITHUB_RETENTION_DAYS', '30'))
    GITHUB_DETAIL_RETRY_SECONDS = int(os.getenv('GITHUB_DETAIL_RETRY_SECONDS', '60'))
